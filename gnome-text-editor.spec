...
Source0  : https://download.gnome.org/sources/gnome-text-editor/48/gnome-text-editor-48.2.tar.xz
...
%prep
%setup -q -n gnome-text-editor-48.2
cd %{_builddir}/gnome-text-editor-48.2
pushd ..
cp -a gnome-text-editor-48.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742868355
