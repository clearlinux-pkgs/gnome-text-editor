...
Version  : 43.1
Release  : 8
URL      : https://download.gnome.org/sources/gnome-text-editor/43/gnome-text-editor-43.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-text-editor/43/gnome-text-editor-43.1.tar.xz
...
%prep
%setup -q -n gnome-text-editor-43.1
cd %{_builddir}/gnome-text-editor-43.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664919704
