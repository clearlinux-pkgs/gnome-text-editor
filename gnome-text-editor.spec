...
Source0  : https://download.gnome.org/sources/gnome-text-editor/43/gnome-text-editor-43.2.tar.xz
...
%prep
%setup -q -n gnome-text-editor-43.2
cd %{_builddir}/gnome-text-editor-43.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673450869
