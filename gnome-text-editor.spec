...
Source0  : https://download.gnome.org/sources/gnome-text-editor/42/gnome-text-editor-42.2.tar.xz
...
%prep
%setup -q -n gnome-text-editor-42.2
cd %{_builddir}/gnome-text-editor-42.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655480456
...
cp %{_builddir}/gnome-text-editor-42.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-text-editor/338650eb7a42dd9bc1f1c6961420f2633b24932d
