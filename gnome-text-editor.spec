...
Source0  : https://download.gnome.org/sources/gnome-text-editor/45/gnome-text-editor-45.1.tar.xz
...
%prep
%setup -q -n gnome-text-editor-45.1
cd %{_builddir}/gnome-text-editor-45.1
pushd ..
cp -a gnome-text-editor-45.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698698087
