...
Version  : 42.0
Release  : 1
URL      : https://download.gnome.org/sources/gnome-text-editor/42/gnome-text-editor-42.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-text-editor/42/gnome-text-editor-42.0.tar.xz
...
%prep
%setup -q -n gnome-text-editor-42.0
cd %{_builddir}/gnome-text-editor-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648059099
...
cp %{_builddir}/gnome-text-editor-42.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-text-editor/338650eb7a42dd9bc1f1c6961420f2633b24932d
