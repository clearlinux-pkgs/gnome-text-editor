...
Version  : 45.2
Release  : 17
URL      : https://download.gnome.org/sources/gnome-text-editor/45/gnome-text-editor-45.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-text-editor/45/gnome-text-editor-45.2.tar.xz
...
%prep
%setup -q -n gnome-text-editor-45.2
cd %{_builddir}/gnome-text-editor-45.2
pushd ..
cp -a gnome-text-editor-45.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705535658
